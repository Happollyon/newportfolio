...
const reactNBar = document.querySelector('.bar-reactNative')
const pythonBar = document.querySelector('.bar-python')
const sqlBar = document.querySelector('.bar-sql')
const php = document.querySelector('.bar-php')
...
t1.fromTo(htmlBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(90% - 6px)`, ease: Power4.easeout})
    ...
    .fromTo(reactNBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(70% - 6px)`, ease: Power4.easeout})
    .fromTo(pythonBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(70% - 6px)`, ease: Power4.easeout})
    .fromTo(sqlBar, .75, {width: `calc(0% - 6px)`}, {width: `calc(70% - 6px)`, ease: Power4.easeout})
    .fromTo(php, .75, {width: `calc(0% - 6px)`}, {width: `calc(70% - 6px)`, ease: Power4.easeout})
